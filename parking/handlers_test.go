...
func TestCreateParkingLot(t *testing.T) {
	...
	if total != "Created a parking lot with 5 slots" {
		t.Errorf("CreateParkingLot was incorrect, got: %d, want: %d.", total, "Created a parking lot with 5 slots")
	}
}
...
func TestPark(t *testing.T) {
	...
	if park != "Allocated slot number: 1" {
		t.Errorf("Park was incorrect, got: %d, want: %d.", park, "Allocated slot number: 1")
	}
}
...
func TestLeave(t *testing.T) {
	...
	if leave != "Slot number 1 is free" {
		t.Errorf("Leave was incorrect, got: %d, want: %d.", leave, "Slot number 1 is free")
	}
}
...
func TestRegistrationNumbersForCarsWithColour(t *testing.T) {
	...
	if carPlateNumber != "KA-01-HH-1234" {
		t.Errorf("RegistrationNumbersForCarsWithColour was incorrect, got: %d, want: %d.", carPlateNumber, "KA-01-HH-1234")
	}
}
...
func TestSlotNumbersForCarsWithColour(t *testing.T) {
	...
	if slotNumber != "1" {
		t.Errorf("SlotNumbersForCarsWithColour was incorrect, got: %d, want: %d.", slotNumber, "1")
	}
}
...
func TestSlotNumberForRegistrationNumber(t *testing.T) {
	...
	if slotNumber != "1" {
		t.Errorf("Park was incorrect, got: %d, want: %d.", slotNumber, "1")
	}
}
